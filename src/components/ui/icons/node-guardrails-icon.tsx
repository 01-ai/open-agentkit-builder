...
export function GuardrailsIcon({ className }: IconProps) {
  return (
    <svg
      width="1em"
      height="1em"
      ...
      className={className}
    >
      <path d="M15.344 10.036a1 1 0 1 0-1.688-1.072l-2.474 3.896-.943-1.034a1 1 0 0 0-1.478 1.348l1.826 2a1 1 0 0 0 1.583-.138l3.174-5Z"></path>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
